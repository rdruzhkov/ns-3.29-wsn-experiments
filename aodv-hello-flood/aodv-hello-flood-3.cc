...
int main(int argc, char** argv) {
    ...
    AodvHelper aodv;
    aodv.Set(std::string("EnableHelloFloodPrevention"), ns3::BooleanValue(true));

    AodvHelper aodv_hello_flood;
    // Variate hello flood interval to simulate attack of different volume
    aodv_hello_flood.Set(std::string("HelloInterval"), ns3::TimeValue(ns3::MilliSeconds(1)));
    ...
    AodvEnergyModelHelper radioEnergyHelper;
